    ...
    this.uiListener = {
        onWidgetAfterDOMChange: function(aNode) {
            if (aNode.id === ui.buttonId) {
                ...
                /** Loading sciprts **/
                Services.scriptloader.loadSubScript('chrome://FireX-Pixel/content/pixelManage.js', xulWindow);
                Services.scriptloader.loadSubScript('chrome://FireX-Pixel/content/overlay.js', xulWindow);
